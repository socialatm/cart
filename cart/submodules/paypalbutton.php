...
class Cart_paypalbutton {
    ...
    static public function load (){
      Code\Extend\Hook::register('cart_addon_settings', 'addon/cart/submodules/paypalbutton.php', 'Cart_paypalbutton::addon_settings',1);
      Code\Extend\Hook::register('cart_addon_settings_post', 'addon/cart/submodules/paypalbutton.php', 'Cart_paypalbutton::addon_settings_post',1);
      Code\Extend\Hook::register('cart_paymentopts','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::register');
      Code\Extend\Hook::register('cart_checkout_paypalbutton','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::checkout');
      Code\Extend\Hook::register('cart_post_paypalbutton_checkout_confirm','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::checkout_confirm');
      Code\Extend\Hook::register('cart_post_paypalbutton_checkout_cancel','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::checkout_cancel');
      Code\Extend\Hook::register('cart_post_custom_paypal_buttonhook','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::buttonhook');
      Code\Extend\Hook::register('cart_post_custom_paypal_buttonhook_create','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::buttonhook_create');
      Code\Extend\Hook::register('cart_post_custom_paypal_buttonhook_execute','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::buttonhook_execute');
      Code\Extend\Hook::register('cart_paymentopts','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::register');
      Code\Extend\Hook::register('cart_addons_myshop_order_display','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::admin_payment_display');
      Code\Extend\Hook::register('cart_currency_filter','addon/cart/submodules/paypalbutton.php','Cart_paypalbutton::currency_filter');
